...
public class GUIUtils {
	...
	public static final boolean MAC_OS = System.getProperty("os.name").toLowerCase().indexOf("mac") > -1;
	
	/**
	 * This is a temporary fix for the videos not showing in fullscreen timeline mode.
	 */
	public static final boolean USE_TRUE_FULL_SCREEN = MAC_OS;
	...
	public static void grow(Rectangle2D r, double amountx, double amounty) {
