...
public class AnimatedFloat { //cobertura:ignore
	...
	public AnimatedFloat(double initialValue, Flag flag) {
	...
	public AnimatedFloat(double initialValue, double quadraticIncrement, double linearIncrement, Flag flag) {
		this(initialValue, quadraticIncrement, linearIncrement, false);
		this.flag = flag;
	}
...
//			flag.changed = false;
		...
		if (Math.abs((destValue - value) / destValue) < 0.001) {
			destValue = value;
			valueChanged = true;
			return valueChanged;
		}
